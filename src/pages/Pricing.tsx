  ...
  const faqs = [
    {
      ...
      answer: "Yes! All our templates are designed to pass Applicant Tracking Systems used by modern employers."
    },
    {
      question: "How do I pay with PayHero?",
      answer: "PayHero accepts M-PESA, credit cards, and bank transfers. Simply click download and choose your preferred payment method."
    },
    {
    ...
    },
    {
      ...
      answer: "We offer a satisfaction guarantee. Contact our support team if you're not happy with your download."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            No subscriptions, no hidden fees. Pay only when you download.
          </p>
        </div>
        ...
        <Card className="mb-16">
          <CardHeader>
            <CardTitle className="text-center text-2xl">Free Preview vs. Paid Download</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-center py-3">Paid Download</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b">
